...
(function ($) {
            ...
            , destroy: function () {
                return this.each(function () {
                    var $this = $(this)
                        , $controlGroup = $this.parents(".form-group").first()
                        , $helpBlock = $controlGroup.find(".help-block").first()
                        , $form = $this.parents("form,dropify").first();
        ...
        , validatorTypes: {
                    ...
                    if (validator.lastFinished === true) {
                        ...
                        executeFunctionByName(validator.callback, window, $this, value, function (data) {
                            if (rrjqbvValidator.lastValue === data.value) {
                                ...
                                setTimeout(function () {
                                    if (!$this.is(":focus") && $this.parents("form,dropify").first().data("jqbvIsSubmitting")) {
            ...
            , match: {
                ...
                , init: function ($this, name) {
                    ...
                    var $form = $this.parents("form,dropify").first();
            ...
            , maxchecked: {
                ...
                , init: function ($this, name) {
                    var result = {};
                    var elements = $this.parents("form,dropify").first().find("[name=\"" + $this.attr("name") + "\"]");
    ...
    var getValue = function ($this) {
        ...
        if (type === "checkbox") {
            ...
            var checkboxParent = $this.parents("form,dropify").first() || $this.parents(".form-group").first();
            if (checkboxParent) {
            ...
            var radioParent = $this.parents("form,dropify").first() || $this.parents(".form-group").first();
            if (radioParent) {
